...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full shadow-sm z-50 font-sans transition-transform duration-300 ${isVisible ? "translate-y-0" : "-translate-y-full"} bg-[linear-gradient(110deg,#ffffff_35%,#9a3412_35%)]`}
      >
          ...
          <div className="flex justify-between items-center h-24">
            ...
            <div className="flex-1 flex justify-start">
              <Link to="/" className="flex items-center">
                <img
                  src="/logo.png"
                  alt="Namesta Logo"
                  className="h-35 w-auto object-contain mt-16"
                />
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div
                  className={`absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-xl overflow-hidden transition-all duration-200 ${isUserMenuOpen ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-2"}`}
                >
                  {user ? (
                    <div className="py-1">
                    ...
                    <div className="py-1">
                      <Link
                        to="/login"
                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600 font-bold"
                      >
                        Sign In
                      </Link>
                      <Link
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 mt-0 w-64 bg-white border border-gray-100 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out">
                  <div className="py-2">
                    ...
                    <Link
                      ...
                      className="block px-6 py-3 text-sm text-gray-700 hover:bg-orange-50 hover:text-orange-600 font-semibold"
                    >
                      Sustainability
                    </Link>
                  </div>
