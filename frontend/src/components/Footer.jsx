      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
          ...
          <div>
            ...
            <p className="text-white mb-6 leading-relaxed font-cursive">
              ...
              finest culinary delights with a modern twist.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/share/17zas2D5Rf/"
              ...
              <a
                href="https://www.instagram.com/namasterestrosydney?igsh=ODF6cWlyZXBhMm95"
                className="text-white hover:text-orange-500 transition-colors"
              >
                <Instagram className="w-5 h-5" />
              </a>
              <a
                href="https://www.tiktok.com/@namastenepalirestaurant1?_r=1&_t=ZS-939GzdnR11j"
                className="text-white hover:text-orange-500 transition-colors"
              >
          ...
          {/* 2. Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-white font-cursive">
              Quick Links
            </h4>
            <ul className="space-y-3 font-cursive">
              <li>
                <Link
                  to="/"
                  className="text-white hover:text-orange-500 transition-colors font-cursive"
                >
                  Home
                </Link>
              </li>
              ...
              <li>
                <a
                  href="#"
                  className="text-white hover:text-white transition-colors font-cursive"
                >
                  Reservations
                </a>
              </li>
            ...
            <ul className="space-y-4 font-cursive">
              <li className="flex items-start space-x-3 text-white font-cursive">
                ...
                <span className="font-cursive">
                  508 Princes Hwy, Rockdale NSW 2216 Phone: (02) 7900 8711
                </span>
              </li>
          ...
          <div>
            ...
            <p className="text-white mb-4 font-cursive">
        ...
        <div className="border-t border-white mt-16 pt-8 text-center text-white text-sm font-cursive">
          <p className="font-cursive">
            &copy; {new Date().getFullYear()} Subhakamana Restaurant. All rights
            reserved.
          </p>
        </div>
      </div>
