const Symbol = () => {
  return (
    <div
      className="h-[600px] bg-cover bg-center bg-no-repeat flex items-center justify-center text-center px-6 mt-16"
      style={{
        backgroundImage:
    ...
    >
      <div className="max-w-3xl">
        {/* Heading */}
        <h1 className="text-white text-5xl md:text-6xl font-bold mb-4 font-cursive">
          Are you hungry?
        </h1>

        {/* Subtitle */}
        <p className="text-gray-200 text-lg md:text-xl mb-8 font-cursive">
