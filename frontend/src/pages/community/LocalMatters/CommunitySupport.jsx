            ...
            <div className="max-w-7xl mx-auto px-22">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="order-2 lg:order-1">
                        <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight font-cursive">
                            Supporting the <br />
                        ...
                        <div className="space-y-6 text-lg text-gray-700 font-cursive">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    <span className="w-1.5 h-1.5 rounded-full bg-orange-500 mt-2.5 flex-shrink-0 font-cursive"></span>
