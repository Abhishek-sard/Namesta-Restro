        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4">
                <div className="bg-gradient-to-br from-orange-600 to-red-700 rounded-[4rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl">
                    ...
                    <h2 className="text-4xl md:text-6xl font-bold mb-8 relative z-10 font-cursive">Join Our <span className="text-orange-200">Local Family</span></h2>
                    <p className="text-xl md:text-2xl text-orange-50 mb-12 max-w-2xl mx-auto relative z-10 opacity-90 font-cursive">
                        Experience authentic flavors while supporting the community that makes it all possible.
                    </p>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                        <Link to="/restaurants/find" className="bg-white text-orange-700 px-8 py-4 rounded-3xl font-bold hover:bg-orange-50 transition-all shadow-lg hover:-translate-y-1">
                            Visit Us
                        </Link>
                        <Link to="/menu" className="bg-transparent border-2 border-white/30 text-white px-8 py-4 rounded-3xl font-bold hover:bg-white/10 transition-all backdrop-blur-sm">
                            View Menu
                        </Link>
