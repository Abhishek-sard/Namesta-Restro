...
const SustainabilityPhilosophy = () => {
    return (
        <section className="py-24 bg-white">
            <div className="max-w-4xl mx-auto px-4 text-center">
                <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-8 font-cursive relative inline-block">
                    Our Philosophy
...
export default SustainabilityPhilosophy;
