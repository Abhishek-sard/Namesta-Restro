...
const Login = () => {
    ...
    return (
        <div className="min-h-screen pt-24 pb-12 flex flex-col justify-center bg-[#fdfaf5] relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-96 h-96 bg-red-100 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl opacity-50"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-100 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl opacity-50"></div>
                ...
                <div className="bg-white py-8 px-4 shadow-2xl shadow-gray-200/50 rounded-3xl sm:px-10 border border-gray-100">
                    <div className="text-center mb-8">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Sign in to your <span className="font-cursive text-red-600 text-lg">Namaste</span> account
                        </p>
                    </div>
